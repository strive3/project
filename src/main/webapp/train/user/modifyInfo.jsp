    ...
    <form id="fm" method="post" enctype="multipart/form-data">
        <table cellspacing="20px">
            ...
            <tr>
                <td>昵称：</td>
                <td>
                    <input type="text" id="nickname" name="real_name" style="width:200px"
            ...
            <tr>
                <td>个人备注：</td>
                <td>
                    <script id="profile" type="text/plain" style="width:80%; height:50%;"></script>
                    <input type="hidden" id="pf" name="user_remark"> <%-- UEditor不能作为表单的一部分提交，所以用这种隐藏域的方式 --%>
                </td>
            </tr>
            <tr>
                <td></td>
